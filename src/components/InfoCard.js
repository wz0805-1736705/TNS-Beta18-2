...
function InfoCard() {
  return (
    <div class="cards">
      <div class="card">
        <img src={require("./city_images/city-1.jpg").default} alt="" />
        <p class="card-desc">
          Discover <br /> Houston
        </p>
      </div>
      <div class="card">
        <img src={require("./city_images/city-2.jpg").default} alt="" />
        <p class="card-desc">
          Discover <br /> Austin
        </p>
      </div>
      <div class="card">
        <img src={require("./city_images/city-3.jpg").default} alt="" />
        <p class="card-desc">
